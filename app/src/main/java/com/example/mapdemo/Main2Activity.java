...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText mail, pass, confirmPass, fullName, number1, number2, homeAddress;
    ...
    public void onClick(View v) {
            ...
            if (TextUtils.isEmpty(email) || TextUtils.isEmpty(password) || TextUtils.isEmpty(confirmPassword) || TextUtils.isEmpty(name) || TextUtils.isEmpty(contact1) || TextUtils.isEmpty(contact2)|| TextUtils.isEmpty(area)) {
